...
function (_Component) {
  ...
  function ComboButton(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ComboButton).call(this, props));
  ...
  _createClass(ComboButton, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          other = _objectWithoutProperties(_this$props, ["children", "onClick", "label", "icon", "iconPosition", "dropdownIcon"]);
      ...
      var comboButton = _react.default.createElement(_ComboButtonStyled.StyledComboButtonContainer, null, _react.default.createElement(_ComboButtonStyled.StyledComboButton, _extends({
        onClick: onClick
