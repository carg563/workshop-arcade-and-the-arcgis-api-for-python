...
var select = (0, _styledComponents.default)(formSelectInputTextarea).withConfig({
  ...
  return props.adornmentDirection && props.adornmentDirection === 'left' && (0, _styledComponents.css)(["border-top-right-radius:0;border-bottom-right-radius:0;"]);
}, function (props) {
  return props.adornmentDirection && props.adornmentDirection === 'right' && (0, _styledComponents.css)(["border-top-left-radius:0;border-bottom-left-radius:0;"]);
}, function (props) {
