...
- We will be using a [Notebook](https://eaglelabs.maps.arcgis.com/) server
...
<img src="/static/assets/understanding-parameters.png" style={{ height: '300px' }} />
...
> [ArcGIS Enterprise Notebook server](https://enterprise.cloud.eaglegis.co.nz/)
